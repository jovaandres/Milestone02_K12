...
@section('container')
    <div class="banner">
        <div class="container-1">
            ...
            <p2>Menemukan hoaks?<a href="">Laporkan disini</a></p2>
        </div>
    </div>
    <div class="info">
        <div class="container-2">
            <div class="section">
                <h1>Apa itu hoaks?</h1>
                <p>Menurut Kamus Besar Bahasa Indonesia (KBBI) hoaks atau dalam bahasa Inggris hoax adalah informasi bohong. Hoaks adalah informasi palsu, berita bohong, atau fakta yang diplintir atau direkayasa untuk tujuan lelucon hingga serius (politis).</p>
            </div>
            <div class="section">
                <h1>Mengapa kita harus khawatir dengan hoaks?</h1>
                <p>Dampak yang ditimbulkan oleh hoaks akan sangat luar biasa. Mulai dari kesalahpahaman kecil hingga berdampak serius terhadap sosial, ekonomi, politik, dan keamanan. Bahkan hoaks juga dapat mengancam keutuhan negara. Penyebaran berita hoax sering terjadi di media sosial dan mempengaruhi pola pikir masyarakat.</p>
            </div>
            <div class="section">
            ...
            <div class="section-2">
                ...
                <p>Seorang pria berinisial IZ alias Unyil (28) diamankan jajaran kepolisian karena aksi perusakan terhadap satu unit mobil ambulans pengangkut pasien Covid-19. Kejadian tersebut berlangsung di Jalan Piyungan-Prambanan KM 1, Yogyakarta. Dari pemeriksaan itu, IZ yang sehari-hari berprofesi sebagai sopir truk ini nekat melakukan perusakan pada ambulans karena termakan isu liar di media sosial.</p>
                <p1>
            ...
            <div class="section">
                ...
                <ul>
                    <li>Berita yang didapatkan menimbulkan kecemasan, kebencian, atau permusuhan antar satu sama lain.</li>
                    ...
                    <li>Berita yang diluncurkan tidak menyeluruh, ada fakta yang disembunyikan, dan memelintir informasi yang diberikan oleh sumber terpercaya.</li>
